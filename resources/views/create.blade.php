            ...
            <div>
                <form method="post" action="{{ route('save') }}">
                    ...
                    <div>
                        ...
                        <input type="radio" name="willing_to_work" value="yes"> Yes
                        <input type="radio" name="willing_to_work" value="no"> No
                    </div>
                    ...
                    <div>
                        ...
                        <input type="checkbox" name="languages[]" value="3"> Spanish
                        <input type="checkbox" name="languages[]" value="4"> Chinese
                    </div>
